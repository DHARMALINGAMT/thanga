...
public class ConnectionRetry {
    ...
    private static final String dbUsername="ewii";
    private static final String dbPassword="ewii";
    ...
    public void connectionResetError() throws Exception{
        ...
        while(rs.next()){
           ...
           /* System.out.println(rs.getString("ITEM_TYPE")+" "+rs.getString("ITEM_KEY")+
                    " "+rs.getString("USER_KEY")+" "+rs.getString("BEGIN_DATE")+" "+
                    rs.getInt("PROCESS_ACTIVITY")+" "+rs.getString("ACTIVITY_STATUS")+" "+rs.getString("ACTIVITY_NAME"));*/
            resetErrorCount++;
            rs.next();
        }
    ...
    private static final void connectionrestRetry() throws Exception{
        Class.forName(driverName);
        Connection con = DriverManager.getConnection(dbConnection,dbUsername,dbPassword);
        Statement st = con.createStatement();
    ...
    public void hangingWorkflow() throws Exception{
        Class.forName(driverName);
        Connection con = DriverManager.getConnection(dbConnection,dbUsername,dbPassword);
        Statement st = con.createStatement();
    ...
    public static void main(String args[]) throws Exception{
       ...
       connectionRetry.connectionResetError();
